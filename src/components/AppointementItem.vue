    ...
    <div class="appointementitem" :class="{expanded: isExpanded}"> <!--To show or not the modify and delete button-->
      <div class="appointementitemalwaysdisplay" @click="toggleExpand">
        ...
        <div class="lign">
          ...
          <div class="info">{{this.appointement.dateDebut.slice(11,-3).replace(":","h")}}</div> <!--To print the date in a human readable manner-->
        </div>
        <div class="lign">
          <div class="sentence">Durée: </div>
          <div class="info">{{appointement.duree.slice(2,4)}} minutes</div> <!--To print the date in a human readable manner-->
        </div>
        <div class="lign">
